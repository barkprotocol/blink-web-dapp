...
// Only import styles once in your main layout
...
// You can use 'mainnet-beta', 'testnet', or 'devnet' here
const network = WalletAdapterNetwork.Devnet

// Blink creation fee percentage
const CREATION_FEE_PERCENTAGE = 2.8

// Wallet address to receive the creation fee
const FEE_RECIPIENT_WALLET = new PublicKey("FEE_RECIPIENT_WALLET_ADDRESS_HERE")

const CreateBlink: React.FC = () => {
  ...
  const { publicKey, sendTransaction, wallet, select, wallets } = useWallet()
